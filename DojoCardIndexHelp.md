# Доджо картотека v 1.0.  Ръкводство на потребителя
...
От това меню всеки активен потребител може да редактира профила си.
За целта е необходимо да промените или да добавите данните посочени в бланката.
След като промените необходимите полета във формата.
Натиснете бутона **"Запази"**.

 ### 2.3.1.2. Съобщение

Бутонът **"Съобщение"** отваря форма за изпращане на съобщение до друг регистриран потребител.
От падащото меню **"Полчател"** избирате потребителят до когото искате да изпратите съобщение.  
Падащото меню показва само регистрирани и активни потребители.  
В полето **"Съобщение"** въведете текста който искате да изпратите.  
Максималната дължина на съобщението не може да надвишава 300 символа.
...
Бутонът **"Заявки"** Показва статуса на изпратените от потребителя заявки за участие.  
Тук всеки потребител може да следи статуса на наравените от него заявки.  
Страницата е разделена на три секции   
- **"Заявки за участие - Статус - ЧАКАЩА"**  
- **"Заявки за участие - Статус - ОДОБРЕНА"**  
- **"Заявка за участие - Статус - ОТХВЪРЛЕНА"**

Освен в тази страница потребителя ще бъде уведомен с мейл за ПОТВЪРЖДЕНИЕ или ОТКАЗ за участие.  

 ### 2.3.1.5. Потребители

Този бутон зареджда лист с активните потребители на клуба.
Всеки потребител може да разгледа профилите на останалите потребители и да изпрати съобщение на някои от списъка.

Ако имате потребителска роля **_"Треньор"_** или **_"Администратор"_** срещу всеки потребител в списъка ще се появят бутони:
- **"Деактивирай"** - който позволява деактивирането на профила на потребител от списъка.  
- **"Редактирай"** - който позволява редактиране на потребителската информация на избран от списъка потребител.  

 ### 2.3.1.6. Нова парола

Този бутон позволява смяната на текущата ларола.  

**!!! ВНИМАНИЕ !!!**  
Моля при промяна на паролата запомнете новата си парола - Треньорите и Администраторите нямат достъп до Вашата парола!  
В случай че все пак сте забравили паролата си и имате проблем с влизането в системата , моля използвайте връзката "Забравена парола", която се намира на Логин страницата.

 ### 2.3.2. Секция "Лични съобщения"

В тази секция потребителят вижда изпратените до него съобщения.  
Всяко получено съобщение предоставя възможност за отгор и изчистване.
- **"Отговори"** - Позволява на потребителя да отоговори на получено съобщение директно до изпращача. Като предоставя възможност за запазване текста на полученото съобщение.  
- **"Изчисти"** -  Този бутон премахва съобщението от списъка със съобщения.

 ### 2.3.3. Секция "Предстоящи събития"

Показва кратка информация на предстоящите събития от календара на клуба.


 ### 2.3.4. Секция "Предстоящи мед. прегледи"
Тази секция е достъпна само за потребители с роля **_"Треньор"_** или **_"Администратор"_**.

Предоставя списък от членове на клуба на които предстой да преминат медицински прегледи.  
За да може тази секция да работи коректно за всеки потребител трябва да бъде зададена дата на която е преминал медицински прегледи. Системата изчислява изминалото време от последният медицински преглед и 30 дни преди изтичането на 1 година от последният преглед предупреждава администраторите ,че този потребител трябва да премине недицински преглед.