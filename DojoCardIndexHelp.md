...
след като попълните данните на потребителя с натиснете бутона **"Добави потребител"** за да създадете потребителя.
  ...
  ### 2.2.2 Регистрирани потребители
...
Потребители те с роля "Треньор" или "Администратор" имат допълнителни права които им позволяват да редактират профил и да деаткивират профила като променят статуса му на "Не активен".  
